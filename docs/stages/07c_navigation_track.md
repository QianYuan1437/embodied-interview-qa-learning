...
**先修**：完成阶段 0–2，并理解基础视觉表示。

**本阶段共 52 题 · 通过标准**：能从传感器、定位和地图讲到语言目标、规划、控制与评测。
...
<details class="qa">
<summary><span class="seq">01</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×5</span> <b>Q01</b> · PointNet 怎么解决点云的"无序性 / 置换不变性"问题？为什么能做点云分类的开山工作？</summary>
...
<details class="qa">
<summary><span class="seq">02</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q02</b> · PointNet++ 相比 PointNet 改进了什么？hierarchical FPS + grouping 解决什么问题？</summary>
...
<details class="qa">
<summary><span class="seq">03</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q03</b> · Point Transformer / PointMLP / PVCNN 各自定位？为什么近几年 PointNet++ 仍是 baseline 但很少作 SOTA？</summary>
...
<details class="qa">
<summary><span class="seq">04</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×5</span> <b>Q04</b> · 单目深度估计：metric depth 和 relative depth 的区别？什么时候必须用 metric？</summary>
...
<details class="qa">
<summary><span class="seq">05</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q05</b> · Depth Anything v2 vs MiDaS vs ZoeDepth 怎么选？室内 / 室外有差别吗？</summary>
...
<details class="qa">
<summary><span class="seq">06</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q06</b> · occupancy network 和 2D occupancy grid map 的本质区别？BEV 和 voxel 各自适用什么场景？</summary>
...
<details class="qa">
<summary><span class="seq">07</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×6</span> <b>Q12</b> · ORB-SLAM3 和 VINS-Fusion 的核心区别？工程上一般怎么选？</summary>
...
<details class="qa">
<summary><span class="seq">08</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q13</b> · VIO 相比纯视觉里程计的优势？IMU 预积分解决了什么核心问题？</summary>
...
<details class="qa">
<summary><span class="seq">09</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q14</b> · 回环检测的两条主流路线：词袋（BoW）vs 学习型（NetVLAD / EigenPlaces）。优劣势？</summary>
...
<details class="qa">
<summary><span class="seq">10</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q15</b> · 因子图优化和滤波（EKF）的区别？为什么现代 SLAM 几乎都用因子图？</summary>
...
<details class="qa">
<summary><span class="seq">11</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q16</b> · Bundle Adjustment 在 SLAM 后端的角色？滑动窗口 BA 怎么控制规模？</summary>
...
<details class="qa">
<summary><span class="seq">12</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×3</span> <b>Q17</b> · sparse SLAM（ORB-SLAM）和 dense SLAM（KinectFusion / NICE-SLAM）的取舍？</summary>
...
<details class="qa">
<summary><span class="seq">13</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×5</span> <b>Q18</b> · A* / Dijkstra / RRT / RRT* 怎么选？哪个能找最优？哪个能高维？</summary>
...
<details class="qa">
<summary><span class="seq">14</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q19</b> · Nav2 vs ROS1 move_base：behavior tree + lifecycle 解决了什么痛点？</summary>
...
<details class="qa">
<summary><span class="seq">15</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q20</b> · 全局规划 vs 局部规划（DWA / TEB）：分工和接口是什么？</summary>
...
<details class="qa">
<summary><span class="seq">16</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q21</b> · 占用栅格地图：log-odds 更新、未知/空闲/占用三态怎么编码？</summary>
...
<details class="qa">
<summary><span class="seq">17</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q22</b> · 拓扑地图 vs 度量地图 vs 语义地图 各自适用于什么任务？</summary>
...
> 在几何栈上接入开放词汇检测、分割和语义地图。

<details class="qa">
<summary><span class="seq">18</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×6</span> <b>Q43</b> · CLIP 和 SigLIP 在 embodied 里的角色？为什么 SigLIP 在小 batch 下更好？</summary>
...
<details class="qa">
<summary><span class="seq">19</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×5</span> <b>Q44</b> · Grounding DINO 是怎么做开放词汇检测的？vs OWL-ViT 区别？</summary>
...
<details class="qa">
<summary><span class="seq">20</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q45</b> · SAM 2 相比 SAM v1 的核心进步？视频 / 流式怎么做？</summary>
...
<details class="qa">
<summary><span class="seq">21</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q46</b> · VLMaps 是怎么构建的？landmark indexing 怎么做？</summary>
...
<details class="qa">
<summary><span class="seq">22</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q47</b> · ConceptFusion：open-set 3D map 怎么把多模态特征融合进去？</summary>
...
<details class="qa">
<summary><span class="seq">23</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q48</b> · Grounded-SAM (DINO + SAM) 在 embodied pipeline 里典型用法？</summary>
...
<details class="qa">
<summary><span class="seq">24</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q49</b> · VLM 在 zero-shot nav 里的幻觉问题怎么处理？常见缓解策略</summary>
...
<details class="qa">
<summary><span class="seq">25</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q50</b> · VLM 推理延迟 vs 准确率 trade-off：cloud-edge 协同 / cache / batched query 怎么取舍？</summary>
...
<details class="qa">
<summary><span class="seq">26</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×3</span> <b>Q51</b> · prompt 工程在 zero-shot nav 中的重要性？chain-of-thought 真的有用吗？</summary>
...
<details class="qa">
<summary><span class="seq">27</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q52</b> · open-vocabulary 检测 vs 闭集检测在导航里：什么时候必须开放词汇？</summary>
...
<details class="qa">
<summary><span class="seq">28</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×6</span> <b>Q23</b> · R2R / RxR / REVERIE / SOON 这几个 VLN 数据集的差别？指令复杂度和任务定义</summary>
...
<details class="qa">
<summary><span class="seq">29</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×5</span> <b>Q24</b> · VLN-CE 相比离散 VLN 的核心区别？waypoint predictor 解决了什么问题？</summary>
...
<details class="qa">
<summary><span class="seq">30</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q25</b> · VLN-BERT / HAMT / DUET 的演进路线？history memory / panorama / cross-modal attention</summary>
...
<details class="qa">
<summary><span class="seq">31</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q26</b> · NaVid 怎么做到"无地图、无深度、无里程计"也能做 VLN-CE？</summary>
...
<details class="qa">
<summary><span class="seq">32</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q27</b> · Uni-NaVid 怎么统一 VLN / ObjectNav / EQA / 人物跟随四类任务？token merging 起什么作用？</summary>
...
<details class="qa">
<summary><span class="seq">33</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×3</span> <b>Q28</b> · NaVILA 的两级框架：VLM 出 mid-level action + RL low-level locomotion，分层为什么必要？</summary>
...
<details class="qa">
<summary><span class="seq">34</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q29</b> · VLN 评估指标 SR / SPL / nDTW 各自衡量什么？SR 高但 SPL 低说明什么？</summary>
...
<details class="qa">
<summary><span class="seq">35</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q30</b> · low-level action space vs high-level action space 在 VLN 里的取舍？</summary>
...
<details class="qa">
<summary><span class="seq">36</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×2 (破例)</span> <b>Q31</b> · VLN-R1：RFT（reinforcement fine-tuning）解决了 SFT 的什么短板？</summary>
...
<details class="qa">
<summary><span class="seq">37</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q32</b> · panorama 全景输入 vs 单目 RGB 输入：哪种更接近真实部署？SmartWay / Fast-SmartWay 怎么取舍？</summary>
...
<details class="qa">
<summary><span class="seq">38</span> <span class="origin">卷七</span> <span class="lv lv-l1">L1</span> <span class="freq">🔥×5</span> <b>Q33</b> · ObjectNav 任务定义？success / SPL 在 HM3D-Sem / MP3D 上的标准评测设定</summary>
...
<details class="qa">
<summary><span class="seq">39</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×5</span> <b>Q34</b> · SemExp 的语义探索是怎么做的？为什么是 CVPR 2020 Habitat Challenge 冠军 baseline？</summary>
...
<details class="qa">
<summary><span class="seq">40</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q35</b> · ZSON 怎么实现 zero-shot？image-goal pretraining + text/image goal embedding 共享</summary>
...
<details class="qa">
<summary><span class="seq">41</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q36</b> · L3MVN：LLM 怎么参与 frontier 选择？相比 SemExp 的核心收益？</summary>
...
<details class="qa">
<summary><span class="seq">42</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q37</b> · VLFM 的 value map 是什么？怎么把 BLIP-2 cos similarity 灌到 frontier 选择？</summary>
...
<details class="qa">
<summary><span class="seq">43</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q38</b> · OpenFMNav 相比 VLFM 的优势？open-set 怎么做？</summary>
...
<details class="qa">
<summary><span class="seq">44</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×4</span> <b>Q39</b> · CoW (CLIP-on-Wheels)：为什么 zero-shot 简单方法能打过学习方法？</summary>
...
<details class="qa">
<summary><span class="seq">45</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×3</span> <b>Q40</b> · Frontier + LLM 评分 vs 端到端 RL：哪种更适合零样本泛化？训练-推理代价对比</summary>
...
<details class="qa">
<summary><span class="seq">46</span> <span class="origin">卷七</span> <span class="lv lv-l2">L2</span> <span class="freq">🔥×3</span> <b>Q41</b> · PIRLNav 的 IL+RL 两阶段：IL warm-up 解决什么？RL fine-tune 又解决什么？</summary>
...
<details class="qa">
<summary><span class="seq">47</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×3</span> <b>Q42</b> · 零样本 ObjectNav 在真实机器人上的核心瓶颈是什么？sim-to-real 最大 gap 在哪？</summary>
...
> 最后评价分层方案和端到端 VLA 的边界。

<details class="qa">
<summary><span class="seq">48</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×3</span> <b>Q53</b> · Habitat vs AI2-THOR vs iGibson 三大仿真器的区别？为什么 ObjectNav 主流用 Habitat？</summary>
...
<details class="qa">
<summary><span class="seq">49</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×3</span> <b>Q54</b> · VLN 在真实机器人 vs 仿真的最大 gap 在哪？哪些 trick 能拉近？</summary>
...
<details class="qa">
<summary><span class="seq">50</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×3</span> <b>Q55</b> · VLMnav / Nav-CoT / RoboFlamingo：端到端 VLN-VLA 真的可行吗？2026 年的判断</summary>
...
<details class="qa">
<summary><span class="seq">51</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×2 (破例)</span> <b>Q56</b> · VLFM vs OpenFMNav 选哪个作 zero-shot baseline？</summary>
...
<details class="qa">
<summary><span class="seq">52</span> <span class="origin">卷七</span> <span class="lv lv-l3">L3</span> <span class="freq">🔥×2 (破例)</span> <b>Q57</b> · 未来 2 年（2026-2028）导航方向的 3 个预测：world model 介入？多机器人协作？VLA 一统？</summary>
